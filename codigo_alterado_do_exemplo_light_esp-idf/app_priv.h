...
esp_err_t app_driver_attribute_update_button(app_driver_handle_t driver_handle, uint16_t endpoint_id, uint32_t cluster_id,
                                      uint32_t attribute_id, esp_matter_attr_val_t *val);
...
esp_err_t app_driver_update_button_from_relay(uint16_t button2_endpoint_id, bool relay_state);
esp_err_t app_driver_update_relay_from_button(uint16_t button2_endpoint_id, bool relay_state);
//esp_err_t app_driver_button1_set_defaults(uint16_t endpoint_id);
//esp_err_t app_driver_button2_set_defaults(uint16_t endpoint_id);
